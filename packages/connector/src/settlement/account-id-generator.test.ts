...
describe('Account ID Generator', () => {
  describe('generateAccountId', () => {
    ...
    it('should generate same account ID for same inputs (determinism)', () => {
      const accountId1 = generateAccountId(
        'connector-a',
        'connector-b',
        'USD',
        AccountType.DEBIT
      ...
      const accountId2 = generateAccountId(
        'connector-a',
        'connector-b',
        'USD',
        AccountType.DEBIT
    ...
    it('should generate different IDs for different account types', () => {
      const debitId = generateAccountId(
        'connector-a',
        'connector-b',
        'USD',
        AccountType.DEBIT
      ...
      const creditId = generateAccountId(
        'connector-a',
        'connector-b',
        'USD',
        AccountType.CREDIT
    ...
    it('should generate different IDs for different peer IDs', () => {
      const peerAId = generateAccountId(
        'connector-a',
        'connector-b',
        'USD',
        AccountType.DEBIT
      ...
      const peerBId = generateAccountId(
        'connector-a',
        'connector-c',
        'USD',
        AccountType.DEBIT
    ...
    it('should generate different IDs for different node IDs', () => {
      const nodeAId = generateAccountId(
        'connector-a',
        'connector-b',
        'USD',
        AccountType.DEBIT
      ...
      const nodeBId = generateAccountId(
        'connector-b',
        'connector-b',
        'USD',
        AccountType.DEBIT
    ...
    it('should generate consistent IDs across multiple calls', () => {
      ...
      const expectedId = generateAccountId(
        'test-node',
        'test-peer',
        'BTC',
        AccountType.DEBIT
