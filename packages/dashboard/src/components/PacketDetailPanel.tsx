...
export function PacketDetailPanel({
  ...
  const truncatedId =
    packet.packetId.length > 20
      ? `${packet.packetId.substring(0, 20)}...`
      : packet.packetId;
        ...
        <Tabs defaultValue="formatted" className="mt-6">
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-gray-400">
              {formatRelativeTime(packet.timestamp)}
            </div>
          </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            copyToClipboard(packet.dataPayload!, 'Data Payload')
                          }
                          className="h-6 text-xs"
                        >
                          Copy
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            copyToClipboard(packet.fulfillment!, 'Fulfillment')
                          }
                          className="h-6 text-xs"
                        >
                          Copy
