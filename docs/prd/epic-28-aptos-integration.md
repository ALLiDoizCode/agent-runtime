...
| **Depends On**       | Epic 27 (Aptos Payment Channel Move Modules)        |
...
Additionally, while Aptos Move contracts and TypeScript SDK are implemented (Epic 27), integration gaps remain:
...
- Epic 27: Aptos Payment Channel Move modules (✅ Complete)
...
- [Epic 27: Aptos Payment Channels](./epic-27-aptos-payment-channels.md)
