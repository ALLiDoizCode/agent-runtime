...
- Integration tests created but deferred due to pre-existing jest configuration issues with @agent-runtime/shared module resolution
- This is a project-wide issue affecting all existing tests, not introduced by this story
- Resolution: Added @agent-runtime/shared as dependency to connector package.json to enable proper module resolution
