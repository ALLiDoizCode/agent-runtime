...
This is Story 28.5 in Epic 28: Public Testnet Integration. This is the final story in the epic, completing production-ready tri-chain settlement support.

**Epic 28 Context:**

- **Story 28.1** (Done): Add Agent Server Aptos HTTP Endpoints
- **Story 28.2** (Done): Add Test Runner Aptos Phases
- **Story 28.3** (Done): Add Public Testnet Configuration
- **Story 28.4** (Done): Update Test Infrastructure for Testnets
- **Story 28.5 (this story)**: Production Connector Aptos Settlement

**Dependencies:**

- Epic 27 (Done): Aptos Payment Channel Move modules and TypeScript SDK
- Story 27.4: AptosChannelSDK implementation
- Story 27.5: UnifiedSettlementExecutor Aptos routing

### Previous Story Insights

From Story 28.4 (Dev Agent Record):
...
- Testnet rate limit mitigation: Add 2s sleep between faucet requests (per Story 28.4 pattern)
...
- The UnifiedSettlementExecutor already had full Aptos support from Story 27.5
- PeerConfig interface already included aptosAddress and aptosPubkey from Story 27.5
...
- [x] UnifiedSettlementExecutor routes APT to settleViaAptos (AC 2, verified via existing Story 27.5)
...
Risk profile: Low - follows established patterns from Epic 27/28
