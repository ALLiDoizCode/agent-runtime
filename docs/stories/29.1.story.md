...
- [x] Task 1: Create Explorer Links Utility Module (AC: 1, 2, 3, 4)
  ...
  - [x] Export explorer base URLs as constants:
    ...
    ```
  - [x] [Source: Epic 29 PRD lines 32-39, 220-232]
...
- [x] Task 3: Implement Explorer URL Builder Function (AC: 4)
  ...
  - [x] URL patterns per PRD (Epic 29 lines 220-232):
  ...
  - [x] [Source: Epic 29 PRD lines 32-39, 94-96, 220-232]
...
This is Story 29.1 in Epic 29: Blockchain Explorer Navigation Links. This is the first story in the epic, providing the foundational utility for address type detection and explorer URL generation that will be consumed by later stories (29.2, 29.3).

**Epic 29 Context:**

- **Story 29.1 (this story)**: Explorer URL Builder Utility & Address Type Detection
...
- Epic 15 (Done): WalletOverview and PaymentChannelCard components

### Previous Story Insights

From Story 28.5 (Dev Agent Record):

- Testnet mode is the recommended approach for blockchain integrations
- Environment variables should be used for blockchain URLs (but this story uses hardcoded testnet URLs per Epic 29 scope)
- Explorer links are currently static text with copy-to-clipboard only (Epic 29 enhancement)
...
[Source: Epic 29 PRD lines 32-39]
...
[Source: Epic 29 PRD lines 100-104, 212-217]
...
[Source: Epic 29 PRD lines 220-232]
...
- `packages/connector/explorer-ui/src/components/FieldDisplay.tsx` - Field components that will consume this utility (Story 29.2)
- `packages/connector/explorer-ui/src/components/WalletOverview.tsx` - Wallet component that will use explorer links (Story 29.3)
...
- **Testnet-only for MVP:** Hardcode testnet URLs per Epic 29 scope (future: environment variables for mainnet)
...
│   └── components/
│       ├── FieldDisplay.tsx            # Will consume utility in Story 29.2
│       └── WalletOverview.tsx          # Will consume utility in Story 29.3
├── package.json
└── tsconfig.json
```
...
**Story 29.2 will use this utility:**
...
Successfully implemented Story 29.1 - Explorer URL Builder Utility & Address Type Detection. Created a centralized utility module for blockchain address type detection and explorer URL generation supporting Aptos, EVM (Base), and XRP blockchains.
...
3. Hardcoded testnet and mainnet URLs per Epic 29 scope (future: environment variables)
...
- `docs/stories/29.1.story.md` (this file - task checkboxes and Dev Agent Record)
...
**Future Enhancements (Per Epic 29 PRD - Out of Scope):**
...
2. Story 29.2 can begin (Enhanced AddressField and HexField Components)
3. Story 29.3 can begin (WalletOverview Explorer Link Integration)
