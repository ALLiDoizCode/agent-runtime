...
- [ ] Task 2: Create Telemetry WebSocket Hook (AC: 7)
  ...
  - [ ] Handle WebSocket connection lifecycle:
    - [ ] onopen: Set connected to true, log connection success
    - [ ] onmessage: Parse JSON, append to events array
    - [ ] onerror: Set error state, log error
    - [ ] onclose: Set connected to false, attempt reconnection after 5s
...
- [ ] Task 7: Style Graph with Minimal Technical Aesthetic (AC: 5, 8)
  ...
  - [ ] **Node styling:**
    ...
    - [ ] Label: Display `data(label)` centered below node
...
```json
{
  ...
  "data": {
    ...
    "peers": [
      { "id": "connectorB", "url": "ws://connector-b:3000", "connected": true, "lastSeen": "2025-12-27T10:00:00.000Z" }
    ],
    "health": "healthy"
  }
}
