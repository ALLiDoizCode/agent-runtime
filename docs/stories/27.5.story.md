...
**From Story 27.4 (Aptos Payment Channel SDK):**
[Source: docs/stories/27.4.story.md]
...
**From Story 27.3 (Off-Chain Claim Signing):**
[Source: docs/stories/27.3.story.md]
...
[Source: docs/prd/epic-27-aptos-payment-channels.md#story-275 + packages/connector/src/settlement/types.ts]
...
[Source: docs/prd/epic-27-aptos-payment-channels.md#story-275]
...
[Source: packages/connector/src/settlement/unified-settlement-executor.ts + Epic 27 requirements]
...
export class UnifiedSettlementExecutor {
   ...
   * @param aptosChannelSDK - AptosChannelSDK for Aptos settlements (Epic 27)
...
- `packages/connector/src/settlement/aptos-channel-sdk.ts` (Story 27.4)
- `packages/connector/src/settlement/aptos-client.ts` (Story 27.1)
- `packages/connector/src/settlement/aptos-claim-signer.ts` (Story 27.3)
...
[Source: Epic 27 Risk Management]
...
Story 27.5 integrates all previous Epic 27 stories:

- Story 27.1: AptosClient for blockchain interactions
- Story 27.3: AptosClaimSigner for off-chain signatures
- Story 27.4: AptosChannelSDK for channel lifecycle
- Uses Move module deployed in Story 27.2 (via SDK)
...
| ---------- | ------- | ---------------------------------- | -------- |
| 2026-01-31 | 0.1     | Initial draft created from Epic 27 | SM Agent |
