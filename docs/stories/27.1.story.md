...
- Story 27.1 follows the same pattern as Story 9.1 but for Aptos instead of XRP
...
**Aptos Client Configuration (New for Story 27.1):**
[Source: Epic 27 Story 27.1 Requirements]
...
[Source: Epic 27 Story 27.1 Requirements + Aptos API Documentation]
...
**AptosClient Interface (New for Story 27.1):**
[Source: Epic 27 Story 27.1 Requirements]
...
[Source: @aptos-labs/ts-sdk documentation + Epic 27 Story 27.1 Requirements]
...
[Source: Epic 27 Story 27.1 Technical Notes]
...
[Source: Epic 27 Story 27.1 AC #9]

Add to `packages/connector/.env.example`:

```bash
# Aptos Configuration (Epic 27)
...
[Source: Epic 27 Story 27.1 AC #10]
...
[Source: Aptos Documentation + Epic 27 Technical Notes]
...
- Epic 27.5 will extend UnifiedSettlementExecutor to support Aptos routing
- Story 27.1 establishes foundation for remaining Epic 27 stories

**Post-Implementation Note:**

After Story 27.1 completion, `docs/architecture/source-tree.md` should be updated to include `aptos-client.ts` in the settlement directory listing alongside `xrpl-client.ts`.

## Tasks / Subtasks

**Task Execution Strategy:** This story establishes the foundational Aptos client for Epic 27. Task 1 installs @aptos-labs/ts-sdk dependency. Task 2 implements AptosClient class wrapping @aptos-labs/ts-sdk with error handling and logging. Task 3 implements retry logic with exponential backoff. Task 4 adds environment variable configuration. Task 5 implements unit tests. Task 6 implements integration tests connecting to Aptos testnet. Task 7 creates developer documentation.
...
- [x] Task 7: Create Developer Documentation (AC: 9, Story 27.1 completion)
