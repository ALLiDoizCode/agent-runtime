...
[Source: docs/prd/epic-27-aptos-payment-channels.md#story-274]
...
[Source: Story 27.4 requirements + existing SDK patterns]
...
**Integration with Story 27.5:**
Story 27.5 (Tri-Chain Settlement Integration) will use AptosChannelSDK in UnifiedSettlementExecutor:
...
- Transaction building follows Aptos SDK patterns from Story 27.1
