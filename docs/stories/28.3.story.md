...
# Story 28.3: Add Public Testnet Configuration
...
**Task Execution Strategy:** This story adds the `NETWORK_MODE` configuration layer that Story 28.4 will use to update the test infrastructure. Focus on environment variable handling and URL configuration.
...
- [x] Task 1: Define Testnet URL Constants ✅ COMPLETE
...
- [x] Task 2: Update TestConfig Interface ✅ COMPLETE
...
- [x] Task 3: Create Network Mode URL Resolution ✅ COMPLETE
...
- [x] Task 4: Update Faucet Functions for Testnet Mode ✅ COMPLETE
...
- [x] Task 5: Add Testnet Timeout Configuration ✅ COMPLETE
...
- [x] Task 6: Add Unit Tests for Network Mode Configuration ✅ COMPLETE
...
This is Story 28.3 (revised) in Epic 28: Public Testnet Integration. The original 28.3 focused on building multi-arch Docker images; this replacement adds public testnet configuration support.

**Epic 28 Context:**

- **Story 28.1** (Done): Add Agent Server Aptos HTTP Endpoints
- **Story 28.2** (Done): Add Test Runner Aptos Phases
- **Story 28.3 (this story)**: Add Public Testnet Configuration
- **Story 28.4**: Update Test Infrastructure for Testnets
...
- `packages/connector/src/test/testnet-config.ts` - ✅ Testnet URL constants and configuration (complete)
...
- Coding Standards: ✓ TypeScript strict mode, proper naming conventions (UPPER_SNAKE_CASE for constants, camelCase for functions), no console.log in production code
- Project Structure: ✓ Co-located tests (`testnet-config.test.ts` alongside `testnet-config.ts`)
- Testing Strategy: ✓ Comprehensive unit tests covering all functions and edge cases
...
Gate: PASS → docs/qa/gates/28.3-add-public-testnet-configuration.yml
