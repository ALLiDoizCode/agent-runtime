...
- Added BTP authentication using shared secrets from environment variables (BTP_PEER_{PEER_ID}_SECRET pattern)
...
**Secrets Management:**
- ✓ BTP shared secrets loaded from environment variables (BTP_PEER_{ID}_SECRET pattern)
