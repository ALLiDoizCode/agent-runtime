...
10. Integration test validates claim signing and local verification; full on-chain submission test deferred to Story 27.4 (requires AptosChannelSDK)

## Dev Notes

### Previous Story Insights

**From Story 27.1 (Aptos SDK Integration):**
...
**From Story 27.2 (Move Payment Channel Module):**
...
[Source: docs/prd/epic-27-aptos-payment-channels.md#story-273]
...
[Source: Story 27.3 requirements + coding standards]
...
[Source: Story 27.3 requirements for AC #7, #8]
...
[Source: Story 27.1 AptosError pattern + Story 27.3 requirements]
...
[Source: @aptos-labs/ts-sdk + Story 27.1 patterns]
...
[Source: Story 27.1 patterns + Epic 27.3 requirements]

Add to `packages/connector/.env.example`:

```bash
# Aptos Claim Signing (Epic 27.3)
...
**Dependencies:**
[Source: Story 27.1 - @aptos-labs/ts-sdk already installed]

No new dependencies required. Uses:

- `@aptos-labs/ts-sdk` (already installed in Story 27.1) for:
...
**Integration Tests (packages/connector/test/integration/aptos-claim-signer.test.ts):**
[Source: Epic 27 Story 27.3 AC #10]
...
[Source: Epic 27 Story 27.3 AC #6, #7]
...
**Key Management:**
[Source: Epic 27 Security Considerations]
...
**Integration with Story 27.4:**
Story 27.4 (AptosChannelSDK) will consume AptosClaimSigner for:
...
- [x] Task 7: Implement Integration Tests (AC: 10)
  ...
  - [x] Note: Full end-to-end test (sign → submit to chain → verify transfer) requires Story 27.4 SDK
...
- [x] Task 8: Add Environment Configuration (AC: 1)
  ...
  - [x] (Optional) Implement createAptosClaimSignerFromEnv() factory function
    - [x] Follows pattern from Story 27.1 createAptosClientFromEnv()
