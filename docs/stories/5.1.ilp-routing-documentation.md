...
- **RFC-0027**: https://interledger.org/rfcs/0027-interledger-protocol-4/ (ILPv4 packet structure, routing)
- **RFC-0031**: https://interledger.org/rfcs/0031-dynamic-configuration-protocol/ (IL-DCP)
- **RFC-0015**: https://interledger.org/rfcs/0015-ilp-addresses/ (ILP address format)
- **RFC-0001**: https://interledger.org/rfcs/0001-interledger-architecture/ (Architecture overview)
